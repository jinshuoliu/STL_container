template <class Key, class T, class HashFcn = hash<Key>, class EqualKey = equal_to<Key>, class Alloc = alooc>
class hash_map {
private:
  typedef hashtable<pair<const Key, T>, Key, HashFcn, identity<Value>, EqualKey, Alloc> ht;
  // 操作都是以底层的hash table来完成的
  ht rep;
